...
namespace EMX.HierarchyPlugin.Editor
{
	...
	partial class EditorSettingsAdapter
	{
		...
		//CUSTOM
		internal bool DRAW_TOPBAR_CUSTOM_LEFT { get { return GET( "DRAW_TOPBAR_CUSTOM_LEFT", false ); } set { var r = DRAW_TOPBAR_CUSTOM_LEFT; SET( "DRAW_TOPBAR_CUSTOM_LEFT", value ); p.modsController.REBUILD_PLUGINS(); p.RepaintAllViews(); } }
