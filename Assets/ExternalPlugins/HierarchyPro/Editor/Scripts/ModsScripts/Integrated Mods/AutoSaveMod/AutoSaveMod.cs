...
namespace EMX.HierarchyPlugin.Editor.Mods
{
	...
	internal class AutoSaveMod
    {
        ...
        static string autoSaveFileName( string source )
        {
            ...
            var as_loc= Application.dataPath + "/" + p.par_e.AS_LOCATION + "/";
            ...
            else
            {
                ...
                if ( files.Length >= p.par_e.AS_FILES_COUNT )
                {
                    ...
                    if ( !f_max_local.StartsWith( Application.dataPath, StringComparison.OrdinalIgnoreCase ) ) throw new Exception( "f_max_local" );
                    f_max_local = "Assets" + f_max_local.Substring( Application.dataPath.Length );
