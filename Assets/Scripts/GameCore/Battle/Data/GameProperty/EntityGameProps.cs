...
namespace Battle.Data.GameProperty
{
    ...
    public class EntityGameProps
    {
        ...
        public virtual IList<ValueDropdownItem<int>> Destinations => IdToName.ValuesFunction(EntityMeta.EntityNames);
    }

    [Serializable]
    public class AllDestinationsGameProps : EntityGameProps
    {
        public override IList<ValueDropdownItem<int>> Destinations => IdToName.ValuesFunction(EntityMeta.AllDestinations);
    }
}